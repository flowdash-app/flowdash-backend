...
class N8NErrorRequest(BaseModel):
    ...
    error: Optional[Dict[str, Any]] = Field(
        None, description="Error details from n8n")
...
async def handle_google_play_notification(
    ...
    try:
        ...
        logger.info(f"handle_google_play_notification: Processing - {notification_data}")
...
async def handle_apple_store_notification(
    ...
    try:
        ...
        logger.info(f"handle_apple_store_notification: Processing - type: {notification_type}")
...
async def test_error_notification(
    ...
    **Usage:**
    ...
    logger.info(f"test_error_notification: Entry - user: {user_id}, instance: {request.instanceId}")
    analytics = AnalyticsService()
